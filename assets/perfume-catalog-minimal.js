// ===== COMPLETE PERFUME CATALOG - MATCHES YOUR PRODUCT INVENTORY =====
 ...
 // ===== CHANEL =====
  chanel: [
    {
      ...
      description: "A fresh and energetic fragrance for the active man. Allure Homme Sport captures the invigorating spirit of sport with sparkling citrus and aquatic notes, leading to a warm and sensual heart of cedar and tonka. The base is smooth and addictive with vanilla and amber.",
      year: "2004",
      gender: "Male"
    },
    {
  ...
  ysl: [
    {
      ...
      description: "A legendary oriental fragrance that is both spicy and sensual. Opium opens with a burst of mandarin and clove, leading to a rich floral heart. The base is deep and intoxicating with opium and myrrh. It's a fragrance of mystery and allure.",
      year: "1977",
      gender: "Female"
    },
    {
    ...
    },
    {
      ...
      description: "A fresh and woody fragrance that represents a new generation. Y opens with sparkling bergamot and ginger, leading to an aromatic heart of sage. The base is warm and sensual with amber and cedar. It's a scent of confidence and freedom.",
      year: "2017",
      gender: "Male"
    }
  ],
  ...
  tomFord: [
    {
      ...
      description: "A seductive and mysterious blend of sweet cherry and smoky notes. Cherry Smoke opens with juicy cherry and saffron, leading to a heart of rose and jasmine infused with a wisp of smoke. The base is warm and sensual with vanilla, amber, and sandalwood.",
      year: "2020",
      gender: "Unisex"
    },
    {
      ...
      heart_notes: ["Vanilla", "Coffee", "Leather"],
      base_notes: ["Amber", "Myrrh", "Benzoin"],
      description: "A dark and intoxicating vanilla fragrance. Vanille Fatale opens with precious saffron and neroli, leading to a heart of rich vanilla blended with smoky coffee and leather. The base is deep and resinous with amber and myrrh.",
      year: "2017",
      gender: "Unisex"
    },
    {
      ...
      heart_notes: ["Vanilla", "Cocoa", "Tonka", "Tobacco Blossom"],
      base_notes: ["Dried Fruits", "Woody Notes"],
      description: "A warm and spicy fragrance with tobacco and vanilla notes. Rich, opulent and sophisticated, this is a signature scent for those who appreciate the finer things in life. It opens with rich tobacco leaf, leading to a decadent heart of vanilla and cocoa.",
      year: "2007",
      gender: "Unisex"
    }
  ],
  ...
  armani: [
    {
      ...
      description: "A sophisticated and seductive fragrance for the modern man. Code opens with fresh bergamot and lemon, leading to a heart of olive blossom. The base is warm and sensual with leather and tonka bean. It's a scent of mystery and elegance.",
      year: "2004",
      gender: "Male"
    },
    {
      ...
      heart_notes: ["Sage", "Lavender", "Cinnamon"],
      base_notes: ["Vanilla", "Chestnut", "Tonka Bean", "Amber"],
      description: "A more intense and powerful interpretation of Stronger With You. This version opens with even more spice, leading to a deeper, richer heart. The base is intensely warm and addictive with vanilla and amber.",
      year: "2019",
      gender: "Male"
    },
    {
      ...
      heart_notes: ["Jasmine", "Rosemary", "Sage"],
      base_notes: ["Cedar", "Patchouli", "Musk"],
      description: "A timeless aquatic classic that captures the essence of the Mediterranean Sea. The citrus opening is fresh and invigorating, while the aromatic heart adds depth. The woody base is clean and masculine.",
      year: "1996",
      gender: "Male"
    },
    {
      ...
      heart_notes: ["Honey", "Almond", "Ginger"],
      base_notes: ["Vanilla", "Sandalwood", "Musk"],
      description: "A seductive and elegant oriental floral fragrance. The orange blossom opening is bright and feminine, while the heart of honey and almond adds a gourmand twist. The vanilla base is warm and sensual.",
      year: "2006",
      gender: "Female"
    },
    {
      ...
      heart_notes: ["Tuberose", "Jasmine"],
      base_notes: ["Vanilla", "Cedar", "White Musk"],
      description: "A radiant and ethical fragrance that celebrates authenticity and connection. My Way opens with bright orange blossom, leading to a heart of tuberose and jasmine. The base is warm and comforting with vanilla and cedar.",
      year: "2020",
      gender: "Female"
    },
    {
      ...
      base_notes: ["Sandalwood", "Musk", "Vanilla"],
      description: "A fresh and feminine fragrance that captures the spirit of modern youth. Emporio Armani She opens with bright lemon and rose, leading to a floral heart of jasmine and peony. The base is soft and sensual with sandalwood and musk.",
      year: "1998",
      gender: "Female"
    },
    {
      ...
      description: "A sophisticated and modern chypre fragrance that celebrates feminine strength. Si opens with fruity black currant, leading to a romantic heart of rose. The base is warm and sensual with vanilla and patchouli.",
      year: "2013",
      gender: "Female"
    }
  ],
  ...
  dior: [
    {
      ...
      description: "A deeper, more intense interpretation of Sauvage. This parfum version opens with fresh bergamot, leading to a heart of lavender and star anise. The base is warm and sensual with sandalwood and vanilla. It's a scent of raw masculinity and elegance.",
      year: "2018",
      gender: "Male"
    },
    {
  ...
  jpg: [
    ...
    },
    {
      ...
      heart_notes: ["Cinnamon", "Sage", "Clary Sage"],
      base_notes: ["Vanilla", "Amber", "Woody Notes"],
      description: "A powerful and seductive fragrance that pushes the boundaries of masculinity. Ultra Male opens with juicy pear and fresh mint, leading to a spicy heart of cinnamon. The base is warm and addictive with vanilla and amber.",
      year: "2015",
      gender: "Male"
    },
    {
      ...
      heart_notes: ["Tuberose", "Jasmine", "Orange Blossom"],
      base_notes: ["Vanilla", "Amber", "Musk"],
      description: "A more intense and sensual interpretation of the iconic Classique. This essence opens with spicy ginger and rose, leading to a rich floral heart of tuberose. The base is warm and addictive with vanilla and amber.",
      year: "2013",
      gender: "Female"
    },
    {
  ...
  pacoRabanne: [
    {
      ...
      description: "A more intense and concentrated version of the iconic 1 Million. This elixir opens with even brighter citrus, leading to a spicier heart with saffron. The base is deeper and richer with vanilla and amber.",
      year: "2020",
      gender: "Male"
    },
    {
  ...
  hugoBoss: [
    ...
    },
    {
      ...
      name: "Hugo",
      brand: "Hugo Boss",
      image: "https://magicperfume.co.uk/cdn/shop/files/bottled_night.png", // Using bottled_night as placeholder
      top_notes: ["Green Apple", "Mint", "Basil"],
      heart_notes: ["Geranium", "Sage", "Cedar"],
      base_notes: ["Musk", "Amber", "Sandalwood"],
      description: "A fresh and energetic fragrance for the young and dynamic man. Hugo opens with crisp green apple and mint, leading to an aromatic heart of geranium. The base is clean and sensual with musk and sandalwood.",
      year: "1995",
      gender: "Male"
    },
    {
  ...
  calvinKlein: [
    ...
    },
    {
      ...
      name: "CK One",
      brand: "Calvin Klein",
      image: "https://magicperfume.co.uk/cdn/shop/files/eternity.png", // Using eternity as placeholder
  ...
  yslNuitBlanche: [
    {
      ...
      heart_notes: ["Jasmine", "Bitter Almond", "Licorice"],
      base_notes: ["Vanilla", "Cedar", "Patchouli"],
      description: "A fresh and luminous interpretation of Black Opium. Nuit Blanche captures the magic of a sleepless night with sparkling coffee and orange blossom, leading to a floral heart of jasmine. The base is warm and addictive with vanilla and patchouli.",
      year: "2017",
      gender: "Female"
    }
  ],
  ...
  chanel: [
    {
      ...
      description: "The most legendary fragrance in the world, Chanel No 5 is an abstract floral aldehyde that revolutionized perfumery. Created in 1921 by Ernest Beaux, it opens with a burst of sparkling aldehydes that give way to a rich bouquet of jasmine and rose. The base is warm and sensual with vanilla and amber, creating a scent that is both timeless and modern.",
      year: "1921",
      gender: "Female"
    },
    {
  ...
  dior: [
    {
      ...
      description: "A deeper, more intense interpretation of the iconic Fahrenheit. Le Parfum amplifies the leather and violet notes, adding rich incense and myrrh for a darker, more mysterious character. It opens with a powerful leather accord, leading to a heart of violet, while the base is deep and resinous with amber and myrrh.",
      year: "2015",
      gender: "Male"
    },
    {
  ...
  ysl: [
    {
      ...
      base_notes: ["Vanilla", "Amber", "Cedar"],
      description: "A bold and free-spirited fragrance that combines the freshness of lavender with the sensuality of orange blossom. Libre opens with aromatic lavender, leading to a heart of orange blossom. The base is warm and addictive with vanilla and amber. It's a scent of freedom and confidence.",
      year: "2019",
      gender: "Female"
    },
    {
  ...
  tomFord: [
    {
      ...
      description: "A seductive and playful fragrance that captures the essence of a forbidden fruit. Lost Cherry opens with juicy cherry and almond, leading to a heart of rose and jasmine. The base is warm and sensual with vanilla and benzoin. It's a scent of temptation and indulgence.",
      year: "2018",
      gender: "Unisex"
    },
    {
  ...
  armani: [
    {
      ...
      description: "A warm and sensual fragrance that celebrates the strength of connection. Stronger With You opens with spicy cardamom, leading to an aromatic heart of sage and lavender. The base is rich and addictive with vanilla and chestnut.",
      year: "2017",
      gender: "Male"
    },
    {
  ...
  jpg: [
    ...
    },
    {
      ...
      heart_notes: ["Cinnamon", "Orange Blossom", "Caraway"],
      base_notes: ["Vanilla", "Tonka Bean", "Amber", "Cedar"],
      description: "An iconic and seductive fragrance for the modern man. Le Male opens with fresh mint and lavender, creating an aromatic and invigorating start.",
      year: "1995",
      gender: "Male"
    }
  ],
  ...
  carolinaHerrera: [
    ...
    },
    {
      ...
      heart_notes: ["Rose", "Jasmine", "Orange Blossom"],
      base_notes: ["Vanilla", "Tonka Bean", "Cedar", "Patchouli"],
      description: "A bold and glamorous interpretation of Good Girl. Very Good Girl opens with juicy red currant and litchi, leading to a heart of luxurious rose.",
      year: "2021",
      gender: "Female"
    },
    {
      ...
      name: "Good Girl",
      brand: "Carolina Herrera",
      image: "https://magicperfume.co.uk/cdn/shop/files/Very_Good_Girl.png", // Using Very Good Girl as placeholder
      top_notes: ["Almond", "Coffee", "Bergamot"],
      heart_notes: ["Tuberose", "Jasmine", "Orange Blossom"],
      base_notes: ["Cocoa", "Vanilla", "Tonka Bean", "Cedar"],
      description: "A captivating and sensual fragrance that plays with the duality of a woman's personality. Good Girl opens with almond and coffee, leading to a floral heart of tuberose.",
      year: "2016",
      gender: "Female"
    }
  ],
  ...
  pacoRabanne: [
    ...
    },
    {
      ...
      heart_notes: ["Sage", "Vetiver", "Patchouli"],
      base_notes: ["Vanilla", "Amber", "Cedar"],
      description: "A futuristic and connected fragrance for a new generation. Phantom opens with fresh lemon and lavender, leading to an aromatic heart of sage.",
      year: "2021",
      gender: "Male"
    },
    {
      ...
      heart_notes: ["Bay Leaf", "Jasmine", "Cedar"],
      base_notes: ["Oakmoss", "Amber", "Patchouli"],
      description: "A fresh and powerful fragrance for the victorious man. Invictus opens with zesty grapefruit and sea notes, leading to an aromatic heart of bay leaf.",
      year: "2013",
      gender: "Male"
    },
    {
      ...
      heart_notes: ["Jasmine", "Rose", "Incense"],
      base_notes: ["Sandalwood", "Vanilla", "Musk"],
      description: "A vibrant and modern fragrance that celebrates self-expression. Fame opens with juicy mango, leading to a floral heart of jasmine.",
      year: "2022",
      gender: "Female"
    },
    {
      ...
      heart_notes: ["Cinnamon", "Rose", "Spices"],
      base_notes: ["Leather", "Amber", "Patchouli"],
      description: "A bold and seductive fragrance for the man who knows his worth. 1 Million opens with fresh grapefruit and mint, leading to a spicy heart of cinnamon.",
      year: "2008",
      gender: "Male"
    }
  ],
  ...
  hugoBoss: [
    {
      ...
      heart_notes: ["Violet Leaf", "Musk", "Ebony Wood"],
      base_notes: ["Sandalwood", "Musk", "Amber"],
      description: "A mysterious and seductive fragrance for evening wear. Boss Bottled Night opens with aromatic lavender and cardamom, leading to a heart of violet leaf and ebony wood.",
      year: "2010",
      gender: "Male"
    },
    {
      ...
      heart_notes: ["Cedar", "Sandalwood", "Patchouli"],
      base_notes: ["Vanilla", "Musk", "Amber"],
      description: "A classic and sophisticated fragrance for the successful modern man. Boss Bottled opens with fresh apple and citrus, leading to a woody heart of cedar and sandalwood.",
      year: "1998",
      gender: "Male"
    },
    {
      ...
      name: "Hugo",
      brand: "Hugo Boss",
      image: "https://magicperfume.co.uk/cdn/shop/files/bottled_night.png",
      top_notes: ["Green Apple", "Mint", "Basil"],
      heart_notes: ["Geranium", "Sage", "Cedar"],
      base_notes: ["Musk", "Amber", "Sandalwood"],
      description: "A fresh and energetic fragrance for the young and dynamic man. Hugo opens with crisp green apple and mint, leading to an aromatic heart of geranium.",
      year: "1995",
      gender: "Male"
    },
    {
      ...
      heart_notes: ["Rose", "Jasmine", "Lily"],
      base_notes: ["Sandalwood", "Musk", "Vanilla"],
      description: "A classic and elegant fragrance for the successful modern woman. Boss Woman opens with fresh mandarin and apple, leading to a floral heart of rose and jasmine.",
      year: "2000",
      gender: "Female"
    },
    {
      ...
      heart_notes: ["Rose", "Jasmine", "Cinnamon"],
      base_notes: ["Vanilla", "Musk", "Cedar"],
      description: "A vibrant and energetic fragrance that celebrates the joy of being alive. Boss Alive opens with juicy apple and black currant, leading to a spicy floral heart of rose and cinnamon.",
      year: "2019",
      gender: "Female"
    },
    {
      ...
      heart_notes: ["Cedar", "Sage", "Geranium"],
      base_notes: ["Sandalwood", "Musk", "Amber"],
      description: "A fresh and energetic interpretation of the iconic Boss Bottled. Infinite opens with zesty grapefruit and apple, leading to a woody heart of cedar.",
      year: "2020",
      gender: "Male"
    }
  ],
  ...
  calvinKlein: [
    {
      ...
      heart_notes: ["Lily of the Valley", "Rose", "Jasmine"],
      base_notes: ["Sandalwood", "Musk", "Amber"],
      description: "A timeless and romantic fragrance that celebrates lasting love. Eternity opens with fresh citrus, leading to a floral heart of lily of the valley and rose.",
      year: "1988",
      gender: "Female"
    },
    {
      ...
      heart_notes: ["Jasmine", "Rose", "Violet", "Nutmeg"],
      base_notes: ["Cedar", "Musk", "Oakmoss", "Amber"],
      description: "A revolutionary fragrance that broke down all barriers. A clean, fresh, and universally appealing citrus aromatic.",
      year: "1994",
      gender: "Unisex"
    }
  ],
  ...
  lancome: [
    {
      ...
      heart_notes: ["Iris", "Jasmine", "Orange Blossom"],
      base_notes: ["Praline", "Vanilla", "Patchouli", "Tonka Bean"],
      description: "A radiant and joyful fragrance that celebrates the beauty of life. La Vie Est Belle opens with fruity black currant and pear, leading to an elegant iris heart.",
      year: "2012",
      gender: "Female"
    },
    {
      ...
      heart_notes: ["Rose", "Jasmine", "Magnolia"],
      base_notes: ["Vanilla", "Musk", "Cedar"],
      description: "A modern and elegant fragrance for the new generation of women. Idôle opens with fresh pear and bergamot, leading to a heart of rose and jasmine.",
      year: "2019",
      gender: "Female"
    },
    {
      ...
      heart_notes: ["Lily of the Valley", "Jasmine", "Iris"],
      base_notes: ["Vanilla", "Sandalwood", "Musk"],
      description: "A romantic and timeless fragrance that captures the essence of love. Trésor opens with juicy peach and apricot, leading to a floral heart of lily of the valley.",
      year: "1990",
      gender: "Female"
    }
  ],
  ...
  mugler: [
    ...
    },
    {
      ...
      heart_notes: ["Honey", "Red Berries", "Peach", "Plum", "Apricot"],
      base_notes: ["Patchouli", "Vanilla", "Chocolate", "Caramel"],
      description: "A revolutionary gourmand fragrance that changed perfumery forever. Angel opens with a unique blend of cotton candy and bergamot, leading to a fruity heart of honey and red berries.",
      year: "1992",
      gender: "Female"
    },
    {
      ...
      name: "Alien",
      brand: "Mugler",
      image: "https://magicperfume.co.uk/cdn/shop/files/angel_edp.png", // Using angel as placeholder
      top_notes: ["Jasmine", "Cashmeran"],
      heart_notes: ["Jasmine", "Cashmeran"],
      base_notes: ["Amber", "Vanilla", "Woody Notes"],
      description: "A mysterious and captivating oriental woody fragrance. Alien opens with a burst of jasmine, leading to a heart of cashmeran. The base is warm and sensual with amber and vanilla.",
      year: "2005",
      gender: "Female"
    }
  ],
  ...
  givenchy: [
    {
      ...
      heart_notes: ["Lily", "Ylang-Ylang", "Orchid"],
      base_notes: ["Vanilla", "Oakmoss", "Brazilian Rosewood"],
      description: "A mysterious and seductive fragrance that plays on the duality of angel and demon. The spicy saffron opening is intriguing, while the floral heart is both angelic and sensual.",
      year: "2006",
      gender: "Female"
    },
    {
  ...
  valentino: [
    ...
    },
    {
      ...
      heart_notes: ["Lavender", "Sage", "Cedar"],
      base_notes: ["Vanilla", "Tonka Bean", "Musk"],
      description: "A fresh and aromatic fragrance for the modern man. Uomo Born in Roma opens with zesty mandarin and salt, leading to an aromatic heart of lavender.",
      year: "2019",
      gender: "Male"
    },
    {
      id: "valentino_uomo_born_in_roma_intense",
      name: "Uomo Born in Roma Intense",
      brand: "Valentino",
      image: "https://magicperfume.co.uk/cdn/shop/files/Uomo_Born_in_Roma.png",
      top_notes: ["Mandarin", "Salt", "Mint"],
      heart_notes: ["Lavender", "Sage", "Iris"],
      base_notes: ["Vanilla", "Tonka Bean", "Leather"],
      description: "A more intense and powerful version of Uomo Born in Roma. This fragrance opens with the same fresh notes but leads to a deeper heart with iris.",
      year: "2020",
      gender: "Male"
    }
  ],
  ...
  prada: [
    {
      ...
      heart_notes: ["Benzoin", "Musk"],
      base_notes: ["Vanilla", "Musk", "Caramel"],
      description: "A playful and indulgent gourmand fragrance that captures the spirit of fun and femininity. Candy opens with sweet caramel, leading to a heart of warm benzoin.",
      year: "2011",
      gender: "Female"
    }
  ],
  ...
  chloe: [
    ...
    },
    {
      ...
      heart_notes: ["Magnolia", "Rose", "Lily of the Valley"],
      base_notes: ["Cedar", "Amber", "Musk"],
      description: "A fresh and elegant rose fragrance that captures the spirit of the modern woman. Chloé opens with sparkling peony and lychee, leading to a heart of romantic rose.",
      year: "2008",
      gender: "Female"
    }
  ],
  ...
  gucci: [
    {
      ...
      heart_notes: ["Rose", "Jasmine", "Lily of the Valley"],
      base_notes: ["Sandalwood", "Musk", "Amber"],
      description: "A bold and modern floral fragrance that captures the energy of urban life. Rush opens with bright freesia and water lily, leading to a heart of romantic rose and jasmine.",
      year: "1999",
      gender: "Female"
    },
    {
    ...
    },
    {
      ...
      heart_notes: ["Rose", "Osmanthus", "Carnation"],
      base_notes: ["Sandalwood", "Patchouli", "Musk"],
      description: "A fresh and elegant floral fragrance that captures the spirit of a garden in bloom. Flora opens with bright citrus and peony, leading to a heart of rose and osmanthus.",
      year: "2009",
      gender: "Female"
    }
  ],
  ...
  bvlgari: [
    {
      ...
      heart_notes: ["Water Notes", "Sage", "Lavender"],
      base_notes: ["Musk", "Amber", "Cedar"],
      description: "A fresh and aquatic fragrance inspired by the Mediterranean Sea. Aqva opens with bright mandarin and neroli, leading to a heart of water notes and sage.",
      year: "2005",
      gender: "Male"
    }
  ],
  ...
  kenzo: [
    {
      ...
      heart_notes: ["Rose", "Jasmine", "Violet"],
      base_notes: ["Vanilla", "Musk", "Cedar"],
      description: "A poetic and delicate fragrance that celebrates the beauty of the poppy flower. Flower opens with fresh hawthorn and black currant, leading to a floral heart of rose and jasmine.",
      year: "2000",
      gender: "Female"
    }
  ],
  ...
  hugoBossScent: [
    {
      ...
      name: "The Scent",
      brand: "Hugo Boss",
      image: "https://magicperfume.co.uk/cdn/shop/files/The_Scent.jpg?v=1772101443",
      top_notes: ["Ginger", "Bergamot", "Mandarin"],
      heart_notes: ["Lavender", "Maninka", "Fruity Notes"],
      base_notes: ["Leather", "Patchouli", "Cedar"],
      description: "A seductive and magnetic fragrance that captures the essence of attraction. The Scent opens with spicy ginger, leading to a heart of lavender and maninka fruit. The base is warm and sensual with leather and patchouli.",
  ...
  jpg: [
    {
      ...
      heart_notes: ["Cinnamon", "Orange Blossom", "Caraway"],
      base_notes: ["Vanilla", "Tonka Bean", "Amber", "Cedar"],
      description: "An iconic and seductive fragrance for the modern man. Le Male opens with fresh mint and lavender, creating an aromatic and invigorating start. The heart reveals spicy cinnamon and orange blossom, while the base is warm and sensual with vanilla and tonka bean. This legendary scent embodies masculinity with a touch of sweetness and sophistication.",
      year: "1995",
      gender: "Male"
    }
  ],
  ...
  chanel: [
    {
      ...
      description: "A fresh and modern oriental fragrance that captures the spirit of a young, confident woman. Coco Mademoiselle opens with sparkling citrus notes, leading to a romantic floral heart of rose and jasmine. The base is warm and sensual with patchouli and vanilla, creating a scent that is both elegant and contemporary.",
      year: "2001",
      gender: "Female"
    }
  ],
  ...
  dior: [
    {
      ...
      heart_notes: ["Leather", "Violet", "Honeysuckle"],
      base_notes: ["Leather", "Vetiver", "Amber"],
      description: "A revolutionary fragrance that combines floral, woody and leather notes. Fahrenheit opens with a unique blend of hawthorn and nutmeg, leading to a surprising heart of leather and violet. The base is warm and sensual with vetiver and amber. An icon representing freedom and individuality since 1988.",
      year: "1988",
      gender: "Male"
    },
    {
      ...
      description: "A bold and intense reinterpretation of Sauvage. Spicy and woody notes create an unexpected, powerful and elegant elixir. The opening is an explosion of spicy grapefruit and cinnamon, leading to a heart of lavender and star anise. The base of liquorice and patchouli provides a deep, dark foundation.",
      year: "2021",
      gender: "Male"
    },
    {
      ...
      heart_notes: ["Jasmine", "Rose", "Lily-of-the-Valley", "Ylang-Ylang"],
      base_notes: ["Vanilla", "Musk", "Cedar"],
      description: "A floral bouquet of exceptional richness. J'adore opens with fresh fruity notes of pear and melon, leading to a magnificent heart of jasmine and rose. The base of vanilla and musk provides a warm, comforting foundation. It's an ode to women everywhere.",
      year: "1999",
      gender: "Female"
    },
    {
      ...
      heart_notes: ["Rose", "Jasmine Sambac", "Lily-of-the-Valley"],
      base_notes: ["Vanilla", "Almond", "Musk"],
      description: "A mysterious and sensual fragrance that weaves a spell of seduction. Hypnotic Poison opens with a unique combination of bitter almond and coconut, leading to a floral heart of rose and jasmine. The base is warm and intoxicating with vanilla and almond. It's a fragrance that leaves a lasting impression.",
      year: "1998",
      gender: "Female"
    },
    {
      ...
      heart_notes: ["Iris Pallida", "Musk", "Ambrette", "Pear"],
      base_notes: ["Virginia Cedar", "Vetiver", "Leather", "Amber Accord"],
      description: "The most concentrated and luxurious version of Dior Homme. This fragrance tells the story of a meeting between the suave and fleshy notes of iris with the powerful accords of amber woods. Rich, powerful and incredibly sophisticated, this is the ultimate expression of the Dior Homme line, designed for those who seek the finest in perfumery.",
      year: "2025",
      gender: "Male"
    }
  ],
  ...
  mugler: [
    {
      ...
      heart_notes: ["Honey", "Red Berries", "Peach", "Plum", "Apricot"],
      base_notes: ["Patchouli", "Vanilla", "Chocolate", "Caramel"],
      description: "A revolutionary gourmand fragrance that changed perfumery forever. Angel opens with a unique blend of cotton candy and bergamot, leading to a fruity heart of honey and red berries. The base is rich and intoxicating with patchouli, vanilla, and chocolate. It's a scent that is both playful and mysterious.",
      year: "1992",
      gender: "Female"
    }
  ],
  ...
  ysl: [
    {
      ...
      heart_notes: ["Jasmine", "Bitter Almond", "Licorice"],
      base_notes: ["Vanilla", "Cedar", "Patchouli"],
      description: "A bold and edgy fragrance that captures the spirit of rock culture. Black Opium opens with a burst of coffee and pink pepper, leading to a floral heart of jasmine. The base is warm and addictive with vanilla and patchouli. It's a scent for the woman who is confident, rebellious, and irresistible.",
      year: "2014",
      gender: "Female"
    },
    {
      ...
      heart_notes: ["Iris", "Jasmine", "Orange Blossom"],
      base_notes: ["Praline", "Vanilla", "Patchouli", "Tonka Bean"],
      description: "A radiant and joyful fragrance that celebrates the beauty of life. La Vie Est Belle opens with fruity black currant and pear, leading to an elegant iris heart. The base is sweet and comforting with praline and vanilla. It's a scent of happiness and femininity.",
      year: "2012",
      gender: "Female"
    }
  ],
  ...
  dolce: [
    {
      ...
      base_notes: ["Cedar", "Amber", "Musk"],
      description: "A fresh and sunny fragrance that captures the essence of the Mediterranean. Light Blue opens with sparkling Sicilian lemon and apple, leading to a floral heart of jasmine and white rose. The base is warm and sensual with cedar and musk. It's a scent of joy and freedom.",
      year: "2001",
      gender: "Female"
    }
  ],
  ...
  armani: [
    {
      ...
      heart_notes: ["Rose", "Freesia", "May Rose"],
      base_notes: ["Vanilla", "Patchouli", "Benzoin"],
      description: "A sophisticated and modern chypre fragrance that celebrates feminine strength. Si opens with fruity black currant, leading to a romantic heart of rose. The base is warm and sensual with vanilla and patchouli. It's a scent for women who are confident, elegant, and true to themselves.",
      year: "2013",
      gender: "Female"
    },
    {
      ...
      heart_notes: ["Jasmine", "Peony", "Lily-of-the-Valley"],
      base_notes: ["Sandalwood", "Musk", "Vanilla"],
      description: "A fresh and feminine fragrance that captures the spirit of modern youth. Emporio Armani She opens with bright lemon and rose, leading to a floral heart of jasmine and peony. The base is soft and sensual with sandalwood and musk. It's a scent of joy and optimism.",
      year: "1998",
      gender: "Female"
    },
    {
  ...
  tomFord: [
    {
      ...
      description: "A bold, provocative fragrance with leather and almond notes. Daring, unique and incredibly fabulous, this fragrance is not for the faint of heart. It opens with sage and lavender, leading to a heart of rich leather and sweet almond. The base is warm and sensual with tonka and amber.",
      year: "2017",
      gender: "Unisex"
    },
    {
      ...
      heart_notes: ["Sandalwood", "Vetiver", "Oud"],
      base_notes: ["Tonka", "Amber", "Vanilla"],
      description: "A mysterious and exotic blend of rare oud wood with smoky notes. Oud Wood opens with rosewood and cardamom, leading to a heart of sandalwood, vetiver, and precious oud. The base is warm and sensual with tonka, amber, and vanilla. It's a fragrance of sophistication and mystery.",
      year: "2007",
      gender: "Unisex"
    }
  ],
  ...
  pacoRabanne: [
    {
      ...
      heart_notes: ["Cinnamon", "Rose", "Spices"],
      base_notes: ["Leather", "Amber", "Patchouli"],
      description: "A bold and seductive fragrance for the man who knows his worth. 1 Million opens with fresh grapefruit and mint, leading to a spicy heart of cinnamon. The base is rich and sensual with leather and amber. It's a fragrance of success and confidence.",
      year: "2008",
      gender: "Male"
    },
    {
      ...
      heart_notes: ["Jasmine", "Rose", "Incense"],
      base_notes: ["Sandalwood", "Vanilla", "Musk"],
      description: "A vibrant and modern fragrance that celebrates self-expression. Fame opens with juicy mango, leading to a floral heart of jasmine. The base is warm and sensual with sandalwood and vanilla. It's a scent for those who dare to be themselves.",
      year: "2022",
      gender: "Female"
    }
  ],
  ...
  cacharel: [
    {
      ...
      heart_notes: ["Honey", "Jasmine", "Rose"],
      base_notes: ["Patchouli", "Tonka Bean", "Cedar"],
      description: "A bold and playful fragrance with a gourmand heart. Scandal opens with juicy mandarin and gardenia, leading to a heart of rich honey. The base is warm and sensual with patchouli and tonka bean. It's a scent of fun and seduction.",
      year: "2017",
      gender: "Female"
    }
  ],
  ...
  lancome: [
    {
      ...
      heart_notes: ["Rose", "Jasmine", "Magnolia"],
      base_notes: ["Vanilla", "Musk", "Cedar"],
      description: "A modern and elegant fragrance for the new generation of women. Idôle opens with fresh pear and bergamot, leading to a heart of rose and jasmine. The base is clean and sensual with vanilla and musk. It's a scent of strength and grace.",
      year: "2019",
      gender: "Female"
    }
  ],
